...
ArgoCD authenticates to your Git repository using SSH deploy keys. During bootstrap, a mise task generates an ED25519 key pair and creates a Kubernetes Secret with the private key. You add the public key to your GitHub repository as a deploy key.
