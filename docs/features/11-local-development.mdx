...
- **[mirrord](https://mirrord.dev/):** Debug local code against traffic from a remote cluster
...
mirrord connects your local development environment to a remote Kubernetes cluster, letting you:

**Steal traffic:** Redirect all traffic from a pod to your local process. Your local code handles real requests while you debug with your IDE.

**Mirror traffic:** Copy traffic without interrupting the running pod. Useful for observing production behavior without risk.
