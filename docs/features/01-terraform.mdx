...
└── live/               # Stack definitions by environment
    ├── shared/         # Cross-account resources (IAM, ECR)
    │   └── global/
...
| Decision | Rationale |
|----------|-----------|
| **Terraform over Pulumi/CDK** | Declarative HCL is easier to review and reason about than imperative code. Larger ecosystem of modules and community support. Lower barrier to entry for teams without strong programming backgrounds. |
