...
| **Terraform over Crossplane** | Simpler operational model—no controller running in-cluster to manage. Better tooling for plan/preview workflows. Crossplane shines for self-service platforms, but adds complexity for smaller teams. |
