...
<Steps>
  <Step title="Open a PR">
    Make changes to any Terraform code, whether modules or live configurations.
  </Step>
...
| Decision | Rationale |
|----------|-----------|
| **Digger over Atlantis/Spacelift/Terraform Cloud** | Digger runs in your own GitHub Actions, so there's no external service to trust with your AWS credentials or state. Simpler to set up, easier to understand, lower cost. |
