...
| `chore:`, `docs:`, `ci:` | No bump | `chore: update dependencies` |
...
In a monorepo with multiple applications, release-please can be configured to:

- **Release all applications together:** Single version for the entire repository
- **Release applications independently:** Each application has its own version and release PR

The kit defaults to releasing all applications together, as this simplifies reasoning about "what version is in production."
