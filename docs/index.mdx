...
<CardGroup cols={3}>
  ...
  <Card title="Release Management" icon="tag" href="/features/08-release-management">
    Automated release PRs with release-please and controlled production deployments
  </Card>
  <Card title="Demo Applications" icon="flask" href="/features/09-demo-applications">
    Fully functional example applications demonstrating end-to-end patterns
  </Card>
  <Card title="Local Development" icon="laptop-code" href="/features/10-local-development">
