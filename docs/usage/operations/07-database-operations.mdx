...
- **[Atlas](https://atlasgo.io/)** - Schema migration tool that runs as an init container
...
│   Deployment      │     │   (init container)│     │   Cluster         │
└───────────────────┘     └───────────────────┘     └───────────────────┘
         │                         │                         │
         │                         ▼                         │
         │                 ┌───────────────┐                 │
...
<Steps>
  ...
  <Step title="Commit and deploy">
    ...
    The migration runs automatically as an init container when the pod starts.
  </Step>
</Steps>

### Migration Init Container

Migrations run as a Kubernetes Job before the application starts:
...
- [Managing Secrets](/usage/operations/06-managing-secrets) - Secure database credentials
- [Observability](/usage/operations/08-observability) - Monitor database performance
