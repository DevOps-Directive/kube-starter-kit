...
2. Choose your data residency region:
   - **US**: `cloud.terramate.io` (default)
   - **Europe**: `cloud.terramate.io/eu`
...
- name: Install Terramate
  ...
  with:
    ...
    cloud_location: us  # or "eu" for Europe
```

<Note>
The `cloud_location` parameter determines which Terramate Cloud region your data is stored in. Choose `eu` if you have data residency requirements for Europe.
</Note>
