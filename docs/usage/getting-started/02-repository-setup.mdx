...
3. Install the GitHub App from your [Terramate Cloud dashboard](https://cloud.terramate.io/) under **Integrations** to enable PR comments and status checks
4. Update the organization and location in `.github/workflows/terramate-preview.yml`:
