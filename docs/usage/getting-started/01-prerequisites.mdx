...
A domain name is required for ingress routing to your services (e.g., `api.staging.example.com`). The kit creates Route53 hosted zones and uses external-dns to automatically manage DNS records.
