...
inputs = {
  ...
  terraform_iam_role_arn = "arn:aws:iam::857059614049:role/github-oidc-provider-aws-chain" # BOOTSTRAP: Set to the arn of the manually created role (which will get imported)
}
