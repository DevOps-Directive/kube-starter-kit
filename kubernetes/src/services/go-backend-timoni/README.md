...
A [timoni.sh](http://timoni.sh) module for deploying go-backend-timoni to Kubernetes clusters.
...
```shell
timoni -n default apply go-backend-timoni oci://<container-registry-url>
```
...
```shell
timoni -n default delete go-backend-timoni
```
